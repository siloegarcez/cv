...
Engenheiro de Software Backend com mais de 4 anos de experiência em Go e Python, atuando na construção de sistemas SaaS B2B multi-tenant. Especialista em arquitetura de serviços, APIs REST e modelagem de dados para aplicações de alta disponibilidade. Experiência sólida em AWS, Linux e DevOps.
...
- **Desenvolvedor Backend Sênior (Jan 2025 - Presente)**
  ...
  de alimentos de múltiplas fontes oficiais, estruturando índices e consultas performáticas com **tempo médio inferior a 15ms.**
  - Projetei e implementei arquitetura escalável e segura na AWS, com ambientes isolados (dev/staging/prod), logs estruturados, métricas, auto scaling e pipeline de CI/CD, **reduzindo o tempo de deploy para ~2 minutos sem downtime.**
  - Projetei e desenvolvi sistema de formulários dinâmicos para anamnese nutricional e física, permitindo que usuários não técnicos personalizem completamente os campos, validações e lógica condicional, **eliminando a necessidade de desenvolvimento sob demanda.**

  **Habilidades:** Multi-Tenant, Liderança Técnica, Escalabilidade, Observabilidade, DevOps, APIs REST, SaaS, CI/CD.
...
- **Desenvolvedor Backend Júnior (Mar 2021 - Dez 2021)**
  ...
  **Habilidades:** Integração com APIs, ChatBots.

  **Tecnologias:** Python, Git, Docker, MariaDB, FastAPI, SQLAlchemy, Pytest, RabbitMQ.


## Formação Acadêmica

- **Bacharelado em Ciência da Computação** Universidade Católica de Brasília (UCB) – 4º semestre (previsão de conclusão: 2028)
